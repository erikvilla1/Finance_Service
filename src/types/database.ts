...
/**
 * A consent, as evidence rather than as a preference. Table exists since
 * migration 0004; document_id added in 0033.
 *
 * `text_version` says which wording was shown (see
 * lib/funding-application/consent-text.ts) and `text_hash` proves it — if the
